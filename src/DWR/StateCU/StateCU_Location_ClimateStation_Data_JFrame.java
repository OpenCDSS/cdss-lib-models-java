...
climate station data in a worksheet.  The worksheet data can be exported to 
a file or printed.
*/
...
*/
public StateCU_Location_ClimateStation_Data_JFrame(Vector data, 
...
throws Exception {
	StateCU_Location_ClimateStation_TableModel tableModel 
		= new StateCU_Location_ClimateStation_TableModel(_data, 
		_editable);
	StateCU_Location_ClimateStation_CellRenderer cellRenderer 
		= new StateCU_Location_ClimateStation_CellRenderer(tableModel);
