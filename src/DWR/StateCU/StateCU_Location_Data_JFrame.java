...
*/
public StateCU_Location_Data_JFrame(JFrame parent, List<StateCU_Location> data, String titleString, boolean editable)
throws Exception {
	super(parent, 780, -1, data, titleString, editable);
