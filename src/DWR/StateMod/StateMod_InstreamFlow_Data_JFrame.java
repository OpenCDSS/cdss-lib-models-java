...
extends StateMod_Data_JFrame<StateMod_InstreamFlow> {
...
*/
public StateMod_InstreamFlow_Data_JFrame(JFrame parent, List<StateMod_InstreamFlow> data, String titleString, boolean editable)
throws Exception {
