...
public class StateMod_Plan_Return_Data_TableModel 
...
*/
public StateMod_Plan_Return_Data_TableModel ( List<StateMod_ReturnFlow> data, boolean editable )
throws Exception {
	if (data == null) {
...
public Object getValueAt(int row, int col) {
	...
	switch (col) {
		case COL_PLAN_ID: return rf.getID();
...
private void setupData(List data) {
	...
	for (int i = 0; i < size; i++) {
		...
		__data[COL_PERCENT_RETURN].add(Double.valueOf(total));
