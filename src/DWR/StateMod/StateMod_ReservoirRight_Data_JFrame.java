...
*/
public StateMod_ReservoirRight_Data_JFrame(JFrame parent, List<StateMod_ReservoirRight> data, String titleString,
boolean editable)
throws Exception {
	super(parent, 990, 350, data, titleString, editable);
	//setSize(750, 350);
...
throws Exception {
	StateMod_ReservoirRight_Data_TableModel tableModel 
		= new StateMod_ReservoirRight_Data_TableModel(_data, _editable);
	StateMod_ReservoirRight_Data_CellRenderer cellRenderer 
		= new StateMod_ReservoirRight_Data_CellRenderer(tableModel);
