...
public class StateMod_Reservoir_Data_JFrame 
...
*/
public StateMod_Reservoir_Data_JFrame(JFrame parent, List<StateMod_Reservoir> data, String titleString, boolean editable)
throws Exception {
	super(parent, 1250, -1, data, titleString, editable);
...
throws Exception {
	StateMod_Reservoir_Data_TableModel tableModel 
		= new StateMod_Reservoir_Data_TableModel(_data, _editable);
	StateMod_Reservoir_Data_CellRenderer cellRenderer 
		= new StateMod_Reservoir_Data_CellRenderer(tableModel);
