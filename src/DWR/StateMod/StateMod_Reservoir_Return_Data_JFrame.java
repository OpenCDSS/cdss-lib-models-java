...
*/
public StateMod_Reservoir_Return_Data_JFrame(List data, String titleString, boolean editable)
throws Exception {
	super();
...
throws Exception {
	StateMod_Reservoir_Return_Data_TableModel tableModel 
		= new StateMod_Reservoir_Return_Data_TableModel(_data, _editable);
	StateMod_Reservoir_Return_Data_CellRenderer cellRenderer 
		= new StateMod_Reservoir_Return_Data_CellRenderer(tableModel);
