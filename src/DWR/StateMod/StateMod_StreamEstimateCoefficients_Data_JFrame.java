...
*/
public StateMod_StreamEstimateCoefficients_Data_JFrame(JFrame parent, List<StateMod_StreamEstimate_Coefficients> data, 
String titleString, boolean editable)
throws Exception {
	super(parent, 582, -1, data, titleString, editable);
