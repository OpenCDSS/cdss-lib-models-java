...
*/
public StateMod_WellRight_Data_JFrame( JFrame parent, List<StateMod_WellRight> data, String titleString, boolean editable)
throws Exception {
	super(parent, 748, -1, data, titleString, editable);
