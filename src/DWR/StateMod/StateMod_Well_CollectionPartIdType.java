...
*/
public enum StateMod_Well_CollectionPartIdType
{
    /**
    ...
    */
     ...
     */
    private StateMod_Well_CollectionPartIdType(String displayName) {
 ...
 */
public static StateMod_Well_CollectionPartIdType valueOfIgnoreCase(String name)
{   if ( name == null ) {
        return null;
    }
    StateMod_Well_CollectionPartIdType [] values = values();
    for ( StateMod_Well_CollectionPartIdType t : values ) {
